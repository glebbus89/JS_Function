...
//     name: '',
//     eat() {
//         console.log(`животное ${this.name} ест`);
//     }
...
//     deposit(amount){
//         this.balance += amount;
//         console.log(`Deposited ${this.balance} into account ${this.accountNumber}. New balance: ${this.balance}`);
//     }
//     withdraw(amount){
//         if (this.balance >= amount) {
//             this.balance -= amount;
//             console.log(`Withdrawn ${this.balance} from account ${this.accountNumber}. New balance: ${this.balance}`);
//         } else {
